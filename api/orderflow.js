...
export default async function handler(req,res){
 try{
  ...
  const raw=50+imb*28+tradeImb*32-(spreadPct!=null&&spreadPct>.15?8:0),score=Math.round(clamp(raw));
